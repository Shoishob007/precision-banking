...
import { ArrowLeft, Shield, Clock, ArrowDownLeft, ArrowUpRight, ArrowLeftRight, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="p-8 lg:p-12 max-w-4xl mx-auto w-full">
      ...
      >
        <div className="flex justify-between items-start mb-12">
          ...
          <div className={cn(
            ...
            tx.status === 'success' ? "bg-secondary-container text-on-secondary-container" : "bg-error-container text-on-error-container"
          )}>
      ...
      <div className="mt-8 text-center">
        <p className="text-[9px] text-on-surface-variant uppercase tracking-[0.4em] font-medium">
          Verified by Precision Protocol • Immutable Ledger Entry
        </p>
      </div>
    </div>
  );
